...
type Tracer struct {
	...
	Batcher  string  `protobuf:"bytes,1,opt,name=batcher,proto3" json:"batcher,omitempty"`   // otlp-grpc或者otlp-http
	...
	Env      string  `protobuf:"bytes,4,opt,name=env,proto3" json:"env,omitempty"`           // 运行环境：dev、production 默认读GO_ENV
...
var file_conf_v1_kratos_conf_tracer_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x07, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x76, 0x31, 0x22, 0x86, 0x01, 0x0a, 0x06,
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x65, 0x6e, 0x76, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x73, 0x65,
	0x63, 0x75, 0x72, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x6e, 0x73, 0x65,
	0x63, 0x75, 0x72, 0x65, 0x42, 0x9c, 0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x6e,
	0x66, 0x2e, 0x76, 0x31, 0x42, 0x15, 0x4b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x43, 0x6f, 0x6e, 0x66,
	0x54, 0x72, 0x61, 0x63, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x67,
